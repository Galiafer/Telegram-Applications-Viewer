...
OUTPUT_CHAT = "АЙДИ_ЧАТА" # Если установлено None (Без кавычек), то логи не будут приходить в канал | Айди канала можете узнать у https://t.me/getmyid_arel_bot , нужно добавить его в чат и прописать /my_id @my_bot
